...
function Hosts() {
	...
	var self = this;
	self.routes = {
		"craydent_socket":{host:"localhost",port:4000,path:"/"},
	...
	self.port = 80;
	self.host = "";
	self.HTTP_AUTH_USERNAME = "admin";
	self.HTTP_AUTH_Password = "admin";
}

var config = {
	"routes": [{"host":"","port":8080,"headers":{},"allowed":"*","verbs":"get,post,put,delete"}],
	"port": 80,
	"host": ""
}